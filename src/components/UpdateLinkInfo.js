...
function UpdateLinkInfo(props) {
  ...
  useEffect(() => {
    axios
      ...
      // .get(`http://localhost:8082/api/links/${id}`) -> same as showlinkdetails - so no conflict with test.js (the localhost:3000/:urlId to redirect
      .then((res) => {
        setLink({
          ...
          <div className='col-md-8 m-auto align-items-center'>
            ...
            <form onSubmit={onSubmit} className='form-inline'>
              <div className='form-group'>
                <label className='form-label mt-2'>s5n.co/</label>
                <input
                  type='text' // url
